...
/**
 * 功能解释如下： -i 功能：java -jar LangTool.jar ./*.xls 将EXCEL文件输出到各个语言对应的xml文件。
 * 输出：/prj/res/(values, values-ar, values-...) -e 功能: java -jar LangTool.jar -e
 * test_8_16 test_8_16是工程文件目录目录格式： /prj(test_8_16)/res/(values, values-zh)
